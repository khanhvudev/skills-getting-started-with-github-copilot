...
activities = {
    ...
    "Basketball Club": {
        "description": "Build court skills, conditioning, and game strategy",
    ...
    "Choir": {
        "description": "Develop vocal technique and perform as a group",
        "schedule": "Tuesdays and Thursdays, 3:15 PM - 4:15 PM",
        "max_participants": 24,
